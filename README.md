...
| [CMIP6 QLD][CMIP6 QLD] | \~10 km², \~20 km | NetCDF | Monthly rainfall | Gridded climate surfaces derived from regional projection models (QLD-DEC) | NCI account and membership of the research project | hourly to monthly, historical (1970-2014) and SSP (2.6, 4.5, 7.0) and several GCMs |
